...
# This technique was inspired by the gazelle rule
# implementation in bazelbuild/rules_go:
# https://github.com/bazelbuild/rules_go/blob/
...
_workspace_binary_script = rule(
    ...
    executable = True,
    implementation = (
        _workspace_binary_script_impl
    ),
)

# Wraps a binary to be run in the workspace root
# via bazel run.
#
...
# workspace_binary(
#     name = "dep",
#     cmd = "//vendor/github.com/golang/dep/"
#           "cmd/dep",
# )
#
